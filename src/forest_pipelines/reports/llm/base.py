...
def _build_prompts(
    ...
    if locale == "pt":
        ...
        user_prompt = (
            ...
            "Use os números de monthly_analysis.rolling_12_months para comparar os últimos 12 meses "
            "com os 12 meses anteriores (variação %). "
    ...
    user_prompt = (
        ...
        "- overview: general reading of the recent analysis window. "
            "Use monthly_analysis.rolling_12_months values to compare the latest 12 months "
            "with the prior 12 months (% change). "
