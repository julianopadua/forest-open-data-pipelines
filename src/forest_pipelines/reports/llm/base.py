...
def _build_prompts(
    ...
    if locale == "pt":
        ...
        user_prompt = (
            ...
            f"{context_json}\n\n"
            "Instruções de saída:\n"
            "- headline: frase principal de síntese factual combinando o mês mais recente e o acumulado do ano.\n"
            "- overview: leitura geral curta da janela recente, mencionando tendência mensal e anual.\n"
            "- comparison: comparação objetiva em três partes: "
            "(1) mês mais recente vs mesmo mês do ano anterior, "
            "(2) acumulado do ano atual vs mesmo período do ano anterior, "
            "(3) total anual vs ano anterior. Use os dados de 'monthly_analysis' do contexto.\n"
    ...
    user_prompt = (
        ...
        f"{context_json}\n\n"
        "Output instructions:\n"
        "- headline: main factual synthesis combining the most recent month and year-to-date totals.\n"
        "- overview: short general reading of the recent window, mentioning both monthly and annual trends.\n"
        "- comparison: objective comparison in three parts: "
        "(1) latest month vs same month previous year, "
        "(2) year-to-date current year vs same period previous year, "
        "(3) full annual total vs previous year. Use 'monthly_analysis' data from the context.\n"
