# src/forest_pipelines/datasets/cvm/fi_cad_nao_adaptados_rcvm175.py
...
def sync(
    ...
    cfg = load_dataset_cfg(settings.datasets_dir, "cvm/fi_cad_nao_adaptados_rcvm175")

    data_filename = "cad_fi.csv"
    meta_filename = "meta_cad_fi.txt"
