# src/forest_pipelines/datasets/cvm/fi_cad_registro_fundo_classe.py
...
def sync(settings: Any, storage: Any, logger: Any) -> dict[str, Any]:
    ...
    local = settings.data_dir / "cvm_fi_cad_registro_fundo_classe" / data_filename
    ...
    meta_local = settings.data_dir / "cvm_fi_cad_registro_fundo_classe" / meta_filename
